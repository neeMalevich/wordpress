<?php 
/* Template Name: Закупки (личный кабинет) */
get_header(); 
        ...
        <section class="gray-bg main-dashboard-sec" id="sec1">
            <div class="container">
                        ...
                        <div class="user-profile-menu-wrap fl-wrap block_box">
                            ...
                            <div class="user-profile-menu">
                                ...
                                <ul class="no-list-style">
                                    ...
                                    <li><a href="/account/" class="user-profile-act"><i class="fal fa-chart-bar"></i>Закупки</a></li>
                ...
                <div class="col-md-9">
                    ...
                    <div id="zakupki-table" class="fl-wrap block_box">
                        <table>
                            <thead>
                              <tr>
                                <th></th>
                                <th></th>
                                <th colspan="3">Ключевые бренды</th>
                                <th></th>
                            ...
                            <tbody>
                              ...
                              while(have_rows('zakupki', 'user_'.$owner)){ 
                              the_row();
                              
                              echo '<tr>';
                              echo '<td>'.get_sub_field('period').'</td>';
                              echo '<td></td>';
                              echo '<td>'.get_sub_field('kb_plan').' €</td>';
                              echo '<td>'.get_sub_field('kb_fakt').' €</td>';
                              echo '<td>'.get_sub_field('kb_procent').' %</td>';
                              echo '<td></td>';
                              echo '<td>'.get_sub_field('i_plan').' €</td>';
                              echo '<td>'.get_sub_field('i_fakt').' €</td>';
                              echo '<td>'.get_sub_field('i_procent').' %</td>';
