...
function theme_scripts()
{
	...
	wp_enqueue_script('cookies', 'http://solidauto.loc/wp-content/themes/solid-theme/js/cookies.js');
	wp_enqueue_script('header-scripts', 'http://solidauto.loc/wp-content/themes/solid-theme/js/header-scripts.js', ['jquery']);

	// in footer
	wp_enqueue_script('phone-mask', 'https://unpkg.com/imask', [], null, true);
	wp_enqueue_script('theme-plugins', 'http://solidauto.loc/wp-content/themes/solid-theme/js/plugins.js', ['jquery'], null, true);
	wp_enqueue_script('theme-scripts', 'http://solidauto.loc/wp-content/themes/solid-theme/js/scripts.js', ['theme-plugins'], null, true);
	wp_enqueue_script('map-api', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBHC4yVi2Es6UzGBiUJU-Ivf5qvIClTkjM&libraries=places&callback=initAutocomplete&language=en&region=BY', ['theme-scripts'], null, true);
	wp_enqueue_script('map-plugins', 'http://solidauto.loc/wp-content/themes/solid-theme/js/map-plugins.js', ['map-api'], null, true);
	...
	wp_enqueue_script('map-single', 'http://solidauto.loc/wp-content/themes/solid-theme/js/map-single.js', ['map-api'], null, true);
}
